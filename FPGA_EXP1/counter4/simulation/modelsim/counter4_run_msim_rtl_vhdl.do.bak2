...
vcom -93 -work work {E:/FPGA_EXP/counter4/counter4.vhd}

vcom -93 -work work {E:/FPGA_EXP/counter4/counter4_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  counter4_tb
