...
vcom -93 -work work {E:/seq_detec_hr/seq_generator_hr.vhd}
vcom -93 -work work {E:/seq_detec_hr/seq_detector_hr.vhd}
vcom -93 -work work {E:/seq_detec_hr/seq_detec_hr.vhd}
vcom -93 -work work {E:/seq_detec_hr/divider_sel_hr.vhd}

vcom -93 -work work {E:/seq_detec_hr/seq_detec_hr_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  seq_detec_hr_tb
